    ...
    <>
      <header class="header d-flex flex-wrap align-items-center" data-page="home" data-overlay="true">
        <div class="container d-flex flex-wrap flex-xl-nowrap align-items-center justify-content-between"><a
          class="brand header_logo d-flex align-items-center" href="index.html"><span class="logo"><svg width="48"
          ...
          </svg> </span><span class="accent">Herba</span> <span>list</span></a>
          <nav class="header_nav">
            <ul class="header_nav-list">
              <li class="header_nav-list_item dropdown"><a
                class="nav-link dropdown-toggle d-inline-flex align-items-center" href="#"
                data-bs-toggle="collapse" data-bs-target="#homeMenu" aria-expanded="false"
                aria-controls="homeMenu">Home <i class="icon-caret_down icon"></i></a>
                <div class="dropdown-menu collapse" id="homeMenu">
                  <ul class="dropdown-list">
                    <li class="list-item nav-item" data-page="home"><a class="dropdown-item"
                      href="index.html">Home 01</a></li>
                    <li class="list-item nav-item" data-page="home2"><a class="dropdown-item"
              ...
              <li class="header_nav-list_item dropdown"><a
                class="nav-link dropdown-toggle d-inline-flex align-items-center" href="#"
                data-bs-toggle="collapse" data-bs-target="#shopMenu" aria-expanded="false"
                aria-controls="shopMenu">Shop <i class="icon-caret_down icon"></i></a>
                <div class="dropdown-menu collapse" id="shopMenu">
                  <ul class="dropdown-list">
                    <li class="list-item nav-item" data-page="shop"><a class="dropdown-item"
                      href="shop.html">Shop 01</a></li>
                    <li class="list-item nav-item" data-page="shop2"><a class="dropdown-item"
                      href="shop2.html">Shop 02</a></li>
                    <li class="list-item nav-item" data-page="product"><a class="dropdown-item"
                      href="product.html">Single Product 01</a></li>
                    <li class="list-item nav-item" data-page="product2"><a class="dropdown-item"
                      href="product2.html">Single Product 02</a></li>
                    <li class="list-item nav-item" data-page="compare"><a class="dropdown-item"
              ...
              <li class="header_nav-list_item dropdown"><a
                ...
                aria-controls="newsMenu">News <i class="icon-caret_down icon"></i></a>
                <div class="dropdown-menu collapse" id="newsMenu">
                  <ul class="dropdown-list">
                    <li class="list-item nav-item" data-page="news"><a class="dropdown-item"
                      href="news.html">News 01</a></li>
                    <li class="list-item nav-item" data-page="news2"><a class="dropdown-item"
                      href="news2.html">News 02</a></li>
                    <li class="list-item nav-item" data-page="post"><a class="dropdown-item"
                      href="post.html">Single Post 01</a></li>
                    <li class="list-item nav-item" data-page="post2"><a class="dropdown-item"
              ...
              <li class="header_nav-list_item dropdown"><a
                ...
                aria-controls="pagesMenu">Pages <i class="icon-caret_down icon"></i></a>
                <div class="dropdown-menu collapse" id="pagesMenu">
                  <ul class="dropdown-list">
                    <li class="list-item nav-item" data-page="about"><a class="dropdown-item"
                      href="about.html">About</a></li>
                    <li class="list-item nav-item" data-page="team"><a class="dropdown-item"
                      href="team.html">Team</a></li>
                    <li class="list-item nav-item" data-page="faq"><a class="dropdown-item"
                      href="faq.html">FAQ</a></li>
                    <li class="list-item nav-item" data-page="contacts"><a class="dropdown-item"
                      href="contacts.html">Contacts 01</a></li>
                    <li class="list-item nav-item" data-page="contacts2"><a class="dropdown-item"
                      href="contacts2.html">Contacts 02</a></li>
                    <li class="list-item nav-item" data-page="404"><a class="dropdown-item"
                      href="404.html">Error Page</a></li>
                  </ul>
                </div>
              </li>
            </ul>
          </nav><span class="header_trigger d-inline-flex d-xl-none flex-column justify-content-between"><span
            class="line line--short"></span> <span class="line line"></span> <span
              class="line line--short"></span> <span class="line line"></span></span>
          <div class="header_user d-flex justify-content-end align-items-center">
            <form class="header_user-search" action="#" method="get" data-type="searchForm">
              <input
              class="header_user-search_field field required" type="text" placeholder="Search..."/> <button
                class="header_user-search_btn header_user-action d-inline-flex align-items-center justify-content-center"
                type="submit" data-trigger="search"><i class="icon-search"></i></button></form><a
                  class="header_user-action d-inline-flex align-items-center justify-content-center"
                  href="wishlist.html"><i class="icon-heart"></i> </a><a
                    class="header_user-action d-inline-flex align-items-center justify-content-center"
